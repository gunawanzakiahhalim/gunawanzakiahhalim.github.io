...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="#">Gunawan</a>
  ...
  <div class="container">
    ...
    <section class="testimonial">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <h5>"Bekerja dengan suasa hati yang lebih asik dan mempelajari hal baru setiap harinya. "</h5>
        </div>
      </div>
      <div class="row justify-content-center">
    ...
    <div class="row footer">
      <div class="col text-center">
        <p>2018 All Rights Reserved by Gunawan</p>
      </div>
    </div>
    <!-- Akhir Footer -->
